...
class Mode_Payment_Gateway_CC extends WC_Payment_Gateway_CC
{
	/**
	...
	public function form() {
		...
		$cvc_field = '<p class="form-row form-row-wide">
			<label for="' . esc_attr( $this->id ) . '-card-cvc">' . esc_html__( 'Card code', 'Mode' ) . '&nbsp;<span class="required">*</span></label>
		...
		$default_fields = array(
			'card-number-field' => '<p class="form-row form-row-wide">
				<label for="' . esc_attr( $this->id ) . '-card-number">' . esc_html__( 'Card number', 'Mode' ) . '&nbsp;<span class="required">*</span></label>
			...
			'card-expiry-month-field' => '<p class="form-row form-row-first">
				<label for="' . esc_attr( $this->id ) . '-card-expiry-month">' . esc_html__( 'Expiry (MM)', 'Mode' ) . '&nbsp;<span class="required">*</span></label>
			...
			'card-expiry-year-field' => '<p class="form-row form-row-last">
				<label for="' . esc_attr( $this->id ) . '-card-expiry-year">' . esc_html__( 'Expiry (YY)', 'Mode' ) . '&nbsp;<span class="required">*</span></label>
		...
		foreach ( $this->get_tokens() as $token ) {
			echo '<fieldset class="token-cvc" id="token-cvc-'.$token->get_id().'">
                <p class="form-row form-row-wide">
			        <label for="' . esc_attr( $this->id ) . '-saved-card-cvc-'.$token->get_id().'">' . esc_html__( 'Card code', 'Mode' ) . '&nbsp;<span class="required">*</span></label>
