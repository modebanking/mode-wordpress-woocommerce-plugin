...
class Mode_GatewayService {
	...
	public function validateCheckoutSessionResponse( $data ) {
		if ( ! isset( $data['result'] ) || $data['result'] !== 'SUCCESS' ) {
			throw new Mode_GatewayResponseException( 'Missing or invalid session result.' );
		}

		if ( ! isset( $data['session']['id'] ) ) {
			throw new Mode_GatewayResponseException( 'Missing session or ID.' );
		}
	}
	 ...
	 * POST https://mtf.gateway.Mode.com/api/rest/version/50/merchant/{merchantId}/3DSecureId/{3DSecureId}
	 *
	 * @param string $tds_id
	 * @param string $paRes
	 *
	 ...
	 * PUT https://mtf.gateway.Mode.com/api/rest/version/50/merchant/{merchantId}/3DSecureId/{3DSecureId}
	 *
	 * @param array $data
	 * @param array $order
	 ...
	 * https://mtf.gateway.Mode.com/api/rest/version/50/merchant/{merchantId}/session
	 *
	 * @param array $order
	 ...
	 * https://mtf.gateway.Mode.com/api/rest/version/50/merchant/{merchantId}/order/{orderid}/transaction/{transactionid}
	 *
	 * @param string $txnId
	 ...
	 * PUT https://mtf.gateway.Mode.com/api/rest/version/50/merchant/{merchantId}/order/{orderid}/transaction/{transactionid}
	 *
	 * @param string $txnId
	 * @param string $orderId
	 * @param array $order
	 ...
	 * https://mtf.gateway.Mode.com/api/rest/version/50/merchant/{merchantId}/order/{orderid}
	 *
	 * @param string $orderId
	 *
	 * @return array
	 ...
	 * https://eu-gateway.Mode.com/api/rest/version/54/merchant/{merchantId}/token
	 *
