...
class Mode_Gateway extends WC_Payment_Gateway {
	...
	const API_CALLBACK_URL = 'https://bkfo7vhbme.execute-api.eu-west-2.amazonaws.com/production/merchants/callbacks';
	const API_SIGNATURE_URL = 'https://bkfo7vhbme.execute-api.eu-west-2.amazonaws.com/production/merchants/payments/sign';
