...
<html>
    <head>
        <title><?php echo __( 'Processing Secure Payment', 'Mode' ) ?></title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8"/>
        <meta name="description" content="<?php echo __( 'Processing Secure Payment', 'Mode' ) ?>"/>
    ...
    <body onload="return window.document.echoForm.submit()">
        <form name="echoForm" method="post" action="<?php echo $authenticationRedirect['acsUrl'] ?>" accept-charset="UTF-8"
            ...
            <noscript>
                <div id="msg">
                    <div id="submitButton">
                        <input type="submit" value="<?php echo __( 'Click here to continue', 'Mode' ) ?>"
                               class="button"/>
                    </div>
                </div>
            </noscript>
